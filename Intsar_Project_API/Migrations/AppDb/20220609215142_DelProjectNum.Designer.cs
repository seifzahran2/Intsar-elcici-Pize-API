...
namespace Intsar_Project_API.Migrations.AppDb
{
    ...
    [Migration("20220609215142_DelProjectNum")]
    partial class DelProjectNum
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Intsar_Project_API.Models.CompReg", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Intsar_Project_API.Models.DegComp", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Intsar_Project_API.Models._project", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Intsar_Project_API.Models.DegComp", b =>
                {
                    b.HasOne("Intsar_Project_API.Models.CompReg", "compReg")
                        .WithOne("degComp")
                        .HasForeignKey("Intsar_Project_API.Models.DegComp", "compRegId")
